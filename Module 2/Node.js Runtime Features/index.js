...
// with the size of the file. A stream moves the file in smaller chunks, so it
// does not need to keep the whole file in memory and peak memory stays flat
// even when the file is very large.
//
// YOUR EXPLANATION:
//
